...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Apr 2019 pada 09.34
...
('admin', '202cb962ac59075b964b07152d234b70', 'Administrator', 'admin@karuniabakti.com', '085123456789', 'admin', 'N');
...
(11, '202cb962ac59075b964b07152d234b70', 'Fadya Dwi Alfina Devi', 'Gending', 'fadyadwialfina@gmail.com', '085782374'),
(12, '80e2972abf916d126f03bf916dc5f0d6', 'Fadya dwi alfina devi', 'Sumedang', 'fadyadwi@gmail.com', '085745786859');
...
(43, 'Profil', '?module=profil', '<strong>PO Citra&nbsp;</strong>merupakan perusahaan otobis yang beralamat di Sumedang.\r\n', 'gedung.jpg', 'admin', 'Y', 2),
...
(26, 'Lunas', '2019-04-20', '14:24:27', 11),
(27, 'Lunas', '2019-04-23', '07:18:45', 3),
(28, 'Lunas', '2019-04-24', '08:08:49', 12);
...
INSERT INTO `orders_temp` (`id_orders_temp`, `id_tiket`, `id_session`, `jumlah`, `tgl_order_temp`, `jam_order_temp`) VALUES
(44, 2, 'mgbemn5h4t2f6pafq3reqom477', 1, '2019-04-26', '09:21:28');
...
--
ALTER TABLE `orders`
  MODIFY `id_orders` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT untuk tabel `orders_temp`
--
ALTER TABLE `orders_temp`
  MODIFY `id_orders_temp` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
